 ...
 */
package aau.carma.recommenders.jayes.inference.jtree;

import static aau.carma.recommenders.jayes.util.Pair.newPair;
...
import aau.carma.recommenders.internal.jayes.util.ArrayUtils;
import aau.carma.recommenders.jayes.BayesNet;
import aau.carma.recommenders.jayes.BayesNode;
import aau.carma.recommenders.jayes.factor.AbstractFactor;
import aau.carma.recommenders.jayes.factor.arraywrapper.DoubleArrayWrapper;
import aau.carma.recommenders.jayes.factor.arraywrapper.IArrayWrapper;
import aau.carma.recommenders.jayes.inference.AbstractInferer;
import aau.carma.recommenders.jayes.util.BayesNodeUtil;
import aau.carma.recommenders.jayes.util.Graph;
import aau.carma.recommenders.jayes.util.MathUtils;
import aau.carma.recommenders.jayes.util.NumericalInstabilityException;
import aau.carma.recommenders.jayes.util.OrderIgnoringPair;
import aau.carma.recommenders.jayes.util.Pair;
import aau.carma.recommenders.jayes.util.sharing.CanonicalArrayWrapperManager;
import aau.carma.recommenders.jayes.util.sharing.CanonicalIntArrayManager;
import aau.carma.recommenders.jayes.util.triangulation.MinFillIn;
