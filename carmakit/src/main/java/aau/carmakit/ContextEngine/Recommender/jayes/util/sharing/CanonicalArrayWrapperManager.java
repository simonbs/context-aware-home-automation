 ...
 */
package aau.carmakit.ContextEngine.Recommender.jayes.util.sharing;
...
public class CanonicalArrayWrapperManager {
    ...
    private final CanonicalSet<IArrayWrapper> canonicals = new CanonicalSet<IArrayWrapper>() {
        ...
        protected Entry<IArrayWrapper> createEntry(IArrayWrapper array) {
            return new Entry<IArrayWrapper>(array) {
                ...
                @Override
                protected boolean equals(IArrayWrapper array, IArrayWrapper array2) {
